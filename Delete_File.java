...
// Use case description	A company want to send their tender quotation. For security reasons this file will be available to download for specified number of days only. Once the days crossed from the send date, file will be deleted. Now build a logic to validate the expiry date to download the file.
...
// Output: 
// The file is deleted. There is no such file with that filename
  ...
  try 
   ...
   Date currentDate = new Date();
      ...
      if( diffInDays>10){
        ...
        System.out.println("The file is deleted. There is no such file with that filename");
      }else{
